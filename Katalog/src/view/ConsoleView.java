//todo компьютер запрашиивает у пользователя, что вообще он хочет делать и так далее
package view;
...
//.getProductByPath("")
// Поработать с кодом, так чтобы вот он выводил как типо дерево какой-то список и смог допустим принимать в себя какой-то файл с катологом
//todo написать метод который выводит содержимое объекта класса продукт;